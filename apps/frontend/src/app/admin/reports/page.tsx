          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between">
            <div>
              ...
              <p className="text-gray-600">
                {language === 'ar'
                  ? 'تحليل الأداء والإحصائيات المالية والتشغيلية'
                  : 'Performance analysis and financial & operational statistics'}
              </p>
            </div>
            ...
            <div className="flex items-center gap-4 mt-4 md:mt-0">
              <div className="flex items-center gap-2">
                ...
                <select
                  aria-label={language === 'ar' ? 'اختر الفترة الزمنية' : 'Select date range'}
        ...
        <div className="bg-white rounded-lg shadow-sm border mb-8">
          <div className="flex overflow-x-auto">
            {[
              ...
              {
                id: 'financial',
                label: language === 'ar' ? 'مالي' : 'Financial',
                icon: DollarSign,
              },
              {
                id: 'operational',
                label: language === 'ar' ? 'تشغيلي' : 'Operational',
                icon: Truck,
              },
          ...
          <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="bg-white p-6 rounded-lg shadow-sm border">
                ...
                <div
                  className={`flex items-center gap-1 mt-2 ${getGrowthColor(overviewStats.revenueGrowth)}`}
                >
              ...
              <div className="bg-white p-6 rounded-lg shadow-sm border">
                ...
                <div
                  className={`flex items-center gap-1 mt-2 ${getGrowthColor(overviewStats.ordersGrowth)}`}
                >
              ...
              <div className="bg-white p-6 rounded-lg shadow-sm border">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-2xl font-bold text-gray-900">
                      {overviewStats.activeVehicles}
                    </p>
                  </div>
                  <Truck className="w-8 h-8 text-purple-500" />
                </div>
                <div
                  className={`flex items-center gap-1 mt-2 ${getGrowthColor(overviewStats.vehiclesGrowth)}`}
                >
              ...
              <div className="bg-white p-6 rounded-lg shadow-sm border">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-2xl font-bold text-gray-900">
                      {overviewStats.customerSatisfaction}/5
                    </p>
                  </div>
                  <Target className="w-8 h-8 text-yellow-500" />
                </div>
                <div
                  className={`flex items-center gap-1 mt-2 ${getGrowthColor(overviewStats.satisfactionGrowth)}`}
                >
                  ...
                  >
                    ...
                    <div className="text-right">
                      ...
                      <p className="text-xs text-gray-500">
                        {month.orders} {language === 'ar' ? 'طلب' : 'orders'}
                      </p>
                    </div>
                  </div>
                ))}
        ...
        {activeTab === 'financial' && (
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              <div className="bg-white p-6 rounded-lg shadow-sm border">
                ...
                <p className="text-sm text-gray-500">
                  {financialSummary.profitMargin}% {language === 'ar' ? 'هامش ربح' : 'margin'}
                </p>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between p-3 bg-yellow-50 rounded-lg">
                    ...
                    <span className="font-semibold text-yellow-600">
                      {formatCurrency(financialSummary.pendingInvoices)}
                    </span>
                  </div>
                  <div className="flex items-center justify-between p-3 bg-red-50 rounded-lg">
                    ...
                    <span className="font-semibold text-red-600">
                      {formatCurrency(financialSummary.overdueInvoices)}
                    </span>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white p-6 rounded-lg shadow-sm border">
                <h4 className="font-semibold text-gray-900 mb-4">
                  {language === 'ar' ? 'إحصائيات الدفع' : 'Payment Statistics'}
                </h4>
                <div className="space-y-4">
                  <div>
                    <div className="flex justify-between items-center mb-2">
                      <span className="text-sm text-gray-600">
                        {language === 'ar' ? 'متوسط وقت الدفع' : 'Avg Payment Time'}
                      </span>
                      <span className="font-semibold text-gray-900">
                        {financialSummary.averagePaymentTime} {language === 'ar' ? 'يوم' : 'days'}
                      </span>
                    </div>
                    <div className="w-full bg-gray-200 rounded-full h-2">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-lg shadow-sm border">
              <div className="p-6 border-b">
                <h3 className="text-lg font-semibold text-gray-900">
                  {language === 'ar' ? 'أداء المركبات' : 'Vehicle Performance'}
                </h3>
              </div>
              <div className="p-6">
                <div className="space-y-4">
                  ...
                  {topCustomers.map((customer, index) => (
                    ...
                    >
                      ...
                      <div className="text-right">
                        ...
                        <div
                          className={`flex items-center gap-1 justify-end ${getGrowthColor(customer.growth)}`}
                        >
