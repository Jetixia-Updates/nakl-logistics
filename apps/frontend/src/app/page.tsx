      ...
      <section className="container mx-auto px-6 py-20">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative">
            <div
              className={`absolute top-10 ${language === 'ar' ? 'right-10' : 'left-10'} w-72 h-72 bg-primary/10 rounded-full blur-3xl`}
            ></div>
        ...
        <div className="container mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg mb-4 opacity-90">{t('about.p1')}</p>
              <p className="text-lg mb-4 opacity-90">{t('about.p2')}</p>
              <p className="text-lg opacity-90">{t('about.p3')}</p>
            </div>
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8">
              ...
              <div className="space-y-4">
                <ValueItem
                  ...
                  description={t('about.professionalism.desc')}
                />
        ...
        <div className="container mx-auto px-6">
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            <div>
              <div className="flex items-center gap-3 mb-4">
                <Truck className="h-8 w-8 text-primary" />
                <span className="text-2xl font-bold">{language === 'ar' ? 'نقل' : 'Nakl'}</span>
              </div>
          ...
          <div className="border-t border-gray-800 pt-8 text-center text-gray-400">
            ...
            <div className="mt-4">
              <Link
                href="/admin/login"
                className="text-xs text-gray-700 hover:text-gray-500 opacity-50 hover:opacity-100 transition-opacity"
              >
                ⚙️
              </Link>
            </div>
