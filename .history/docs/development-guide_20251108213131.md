...
The application uses OpenTelemetry for distributed tracing. See [Tracing Guide](./tracing-guide.md) for details.

**Quick Start:**
```bash
# Traces are automatically sent to localhost:4318
# View traces in AI Toolkit or run Jaeger:
