...
const translations = {
  ar: {
    ...
    'hero.description': 'نوفر خدمات النقل والشحن واللوجستيات المتكاملة بأعلى معايير الجودة والأمان في جميع أنحاء مصر',
    ...
    // About Section
    'about.title': 'من نحن',
    'about.p1': 'شركة نقل هي إحدى الشركات الرائدة في مجال النقل والخدمات اللوجستية في مصر. نعمل منذ أكثر من 15 عاماً على تقديم حلول نقل متكاملة تلبي احتياجات مختلف القطاعات.',
    'about.p2': 'نفخر بامتلاكنا أسطول حديث من الشاحنات ونظام إدارة متطور يضمن تتبع الشحنات لحظياً وتسليمها في الوقت المحدد بأعلى معايير الأمان.',
    'about.p3': 'رؤيتنا هي أن نكون الخيار الأول لخدمات النقل في مصر والشرق الأوسط، من خلال الابتكار المستمر والالتزام بأعلى معايير الجودة.',
    'about.values': 'قيمنا',
  ...
  en: {
    ...
    'hero.description': 'We provide comprehensive transport, shipping, and logistics services with the highest quality and safety standards across Egypt',
    ...
    'services.subtitle': 'We provide complete transport solutions that meet all your business needs',
    'services.transport': 'Ground Transport',
    'services.transport.desc': 'Comprehensive ground transport services with a modern and diverse fleet including all types of trucks',
    'services.warehouse': 'Storage & Distribution',
    'services.warehouse.desc': 'Modern warehouses equipped with advanced management systems to ensure cargo safety',
    ...
    'services.delivery.desc': 'Fast delivery service with full commitment to specified delivery times',
    ...
    'features.subtitle': 'We excel in experience, professionalism, and commitment to the highest quality standards',
    ...
    'about.p1': 'Nakl Company is one of the leading companies in transport and logistics services in Egypt. We have been working for more than 15 years to provide comprehensive transport solutions that meet the needs of various sectors.',
    'about.p2': 'We are proud to own a modern fleet of trucks and an advanced management system that ensures real-time shipment tracking and delivery on time with the highest safety standards.',
    'about.p3': 'Our vision is to be the first choice for transport services in Egypt and the Middle East, through continuous innovation and commitment to the highest quality standards.',
    'about.values': 'Our Values',
    'about.professionalism': 'Professionalism',
    'about.professionalism.desc': 'We commit to the highest standards of professionalism in everything we do',
    'about.trust': 'Trust',
