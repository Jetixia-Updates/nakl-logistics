  ...
  const customers = [
    {
      ...
      address: language === 'ar' ? 'القاهرة - مدينة نصر - شارع الطيران' : 'Cairo - Nasr City - Aviation Street',
      status: 'active',
      rating: 4.8,
      totalOrders: 45,
      totalValue: 1250000,
      ...
      services: [language === 'ar' ? 'نقل بري' : 'Land Transport', language === 'ar' ? 'تخليص جمركي' : 'Customs Clearance']
    },
    {
      id: 'CUS-002',
      ...
      address: language === 'ar' ? 'الإسكندرية - الدخيلة - المنطقة الصناعية' : 'Alexandria - Dekheila - Industrial Zone',
      status: 'active',
      rating: 4.6,
      totalOrders: 32,
      totalValue: 850000,
      ...
      services: [language === 'ar' ? 'نقل بحري' : 'Sea Transport', language === 'ar' ? 'تخزين' : 'Storage']
    },
    {
      id: 'CUS-003',
      ...
      address: language === 'ar' ? 'الجيزة - الشيخ زايد - المنطقة التجارية' : 'Giza - Sheikh Zayed - Commercial District',
      status: 'pending',
      rating: 4.2,
      totalOrders: 18,
      totalValue: 420000,
  ...
  const vendors = [
    {
      ...
      services: [language === 'ar' ? 'نقل ثقيل' : 'Heavy Transport', language === 'ar' ? 'نقل متخصص' : 'Specialized Transport'],
      performance: 95
    },
    {
      id: 'VEN-002',
      ...
      services: [language === 'ar' ? 'نقل سريع' : 'Express Delivery', language === 'ar' ? 'تخزين' : 'Warehousing'],
      performance: 88
    }
  ];
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">
            {language === 'ar' ? 'إدارة العملاء والموردين ومتابعة المعاملات التجارية' : 'Manage customers, vendors, and track business relationships'}
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          <div className="bg-white p-6 rounded-lg shadow-sm border">
            <div className="flex items-center">
              ...
              <div className={`${language === 'ar' ? 'mr-4' : 'ml-4'}`}>
                ...
                <p className="text-sm text-gray-600">{language === 'ar' ? 'إجمالي العملاء' : 'Total Customers'}</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow-sm border">
            <div className="flex items-center">
              ...
              <div className={`${language === 'ar' ? 'mr-4' : 'ml-4'}`}>
                ...
                <p className="text-sm text-gray-600">{language === 'ar' ? 'إجمالي الموردين' : 'Total Vendors'}</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow-sm border">
            <div className="flex items-center">
              ...
              <div className={`${language === 'ar' ? 'mr-4' : 'ml-4'}`}>
                <p className="text-2xl font-bold text-gray-900">{formatCurrency(customers.reduce((sum, c) => sum + c.totalValue, 0))}</p>
                <p className="text-sm text-gray-600">{language === 'ar' ? 'إجمالي مبيعات العملاء' : 'Total Customer Sales'}</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow-sm border">
            <div className="flex items-center">
              ...
              <div className={`${language === 'ar' ? 'mr-4' : 'ml-4'}`}>
                <p className="text-2xl font-bold text-gray-900">{formatCurrency(vendors.reduce((sum, v) => sum + v.contractValue, 0))}</p>
                <p className="text-sm text-gray-600">{language === 'ar' ? 'قيمة عقود الموردين' : 'Vendor Contract Value'}</p>
              </div>
            </div>
          </div>
        </div>
              ...
              <div key={customer.id} className="bg-white rounded-lg shadow-sm border hover:shadow-md transition-shadow">
                <div className="p-6">
                  ...
                  <div className="flex items-center gap-2 mb-4">
                    ...
                    <span className="text-sm text-gray-500">({customer.totalOrders} {language === 'ar' ? 'طلب' : 'orders'})</span>
                  </div>

                  {/* Financial Info */}
                  <div className="space-y-2 mb-4 p-3 bg-gray-50 rounded-lg">
                    <div className="flex justify-between text-sm">
                      <span className="text-gray-600">{language === 'ar' ? 'إجمالي القيمة:' : 'Total Value:'}</span>
                      <span className="font-medium text-gray-900">{formatCurrency(customer.totalValue)}</span>
                    </div>
                    <div className="flex justify-between text-sm">
                      <span className="text-gray-600">{language === 'ar' ? 'الرصيد المستحق:' : 'Outstanding:'}</span>
                      <span className="font-medium text-red-600">{formatCurrency(customer.outstandingBalance)}</span>
                    </div>
                    <div className="flex justify-between text-sm">
                      <span className="text-gray-600">{language === 'ar' ? 'آخر طلب:' : 'Last Order:'}</span>
                  ...
                  {/* Services */}
                  <div className="mb-4">
                    <p className="text-sm text-gray-600 mb-2">{language === 'ar' ? 'الخدمات:' : 'Services:'}</p>
                  ...
                  <div className="flex gap-2">
                    ...
                    <button className="px-3 py-2 bg-gray-50 text-gray-600 rounded-lg hover:bg-gray-100 transition-colors" aria-label={language === 'ar' ? 'تحرير' : 'Edit'}>
                ...
                <div className="p-6">
                  ...
                  <div className="flex items-start justify-between mb-4">
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-gray-500">{vendor.id} • {vendor.type}</p>
                    </div>
                  ...
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <div className="text-sm">
                      <span className="text-gray-600">{language === 'ar' ? 'الأداء:' : 'Performance:'}</span>
                      <span className={`ml-1 font-medium ${vendor.performance >= 90 ? 'text-green-600' : vendor.performance >= 80 ? 'text-yellow-600' : 'text-red-600'}`}>
                        {vendor.performance}%
                      </span>
                    </div>
                  </div>
                  ...
                  <div className="space-y-2 mb-4 p-3 bg-gray-50 rounded-lg">
                    <div className="flex justify-between text-sm">
                      <span className="text-gray-600">{language === 'ar' ? 'المركبات:' : 'Vehicles:'}</span>
                      <span className="font-medium text-gray-900">{vendor.vehicleCount}</span>
                    </div>
                    <div className="flex justify-between text-sm">
                      <span className="text-gray-600">{language === 'ar' ? 'العقود:' : 'Contracts:'}</span>
                      <span className="font-medium text-gray-900">{vendor.totalContracts}</span>
                    </div>
                    <div className="flex justify-between text-sm">
                      <span className="text-gray-600">{language === 'ar' ? 'قيمة العقود:' : 'Contract Value:'}</span>
                      <span className="font-medium text-green-600">{formatCurrency(vendor.contractValue)}</span>
                    </div>
                    <div className="flex justify-between text-sm">
                      <span className="text-gray-600">{language === 'ar' ? 'آخر دفعة:' : 'Last Payment:'}</span>
