      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">
            {language === 'ar'
              ? 'إدارة أوامر العمل وتتبع حالة الشحنات والعمليات'
              : 'Manage work orders and track shipment and operation status'}
          </p>
        </div>
            ...
            >
              <div className="p-6">
                ...
                <div className="flex items-start mb-3">
                  ...
                  <div>
                    <p className="text-sm text-gray-700 font-medium">
                      {language === 'ar' ? 'من:' : 'From:'} {order.origin}
                    </p>
                    <p className="text-sm text-gray-700">
                      {language === 'ar' ? 'إلى:' : 'To:'} {order.destination}
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-center mb-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500">
                      {language === 'ar' ? 'السائق:' : 'Driver:'} {order.assignedDriver}
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-center mb-4">
                  ...
                  <div>
                    <p className="text-sm text-gray-700">
                      {language === 'ar' ? 'موعد البدء:' : 'Start Date:'} {order.scheduledDate}
                    </p>
                    <p className="text-sm text-gray-500">
