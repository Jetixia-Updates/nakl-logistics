  ...
  const warehouseData = {
    ...
    inventory: [
      ...
      },
      {
        ...
        location: language === 'ar' ? 'مستودع الإلكترونيات - B2-08' : 'Electronics Warehouse - B2-08',
        value: 340000,
      ...
      {
        id: 'ITM-004',
        name: language === 'ar' ? 'مواد كيميائية - منظفات صناعية' : 'Chemicals - Industrial Cleaners',
    ...
    warehouses: [
      {
        ...
        phone: '+201234567890',
        status: 'active',
        categories: [language === 'ar' ? 'مواد بناء' : 'Construction', language === 'ar' ? 'إلكترونيات' : 'Electronics']
      },
      {
        id: 'WH-002',
        ...
        phone: '+201987654321',
        status: 'active',
        categories: [language === 'ar' ? 'كيماويات' : 'Chemicals', language === 'ar' ? 'مواد خطرة' : 'Hazardous Materials']
      },
      {
        id: 'WH-003',
        ...
        phone: '+201555666777',
        status: 'active',
        categories: [language === 'ar' ? 'قطع غيار' : 'Auto Parts', language === 'ar' ? 'مواد بناء' : 'Construction']
      }
    ]
  };
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">
            {language === 'ar' ? 'إدارة المخزون وحركات البضائع ومراقبة المستودعات' : 'Manage inventory, goods movements, and warehouse monitoring'}
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-6 mb-8">
          <div className="bg-white p-6 rounded-lg shadow-sm border">
            <div className="flex items-center">
              ...
              <div className={`${language === 'ar' ? 'mr-4' : 'ml-4'}`}>
                <p className="text-2xl font-bold text-gray-900">{warehouseData.overview.totalItems}</p>
                <p className="text-sm text-gray-600">{language === 'ar' ? 'إجمالي الأصناف' : 'Total Items'}</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow-sm border">
            <div className="flex items-center">
              ...
              <div className={`${language === 'ar' ? 'mr-4' : 'ml-4'}`}>
                <p className="text-2xl font-bold text-gray-900">{formatCurrency(warehouseData.overview.totalValue)}</p>
                <p className="text-sm text-gray-600">{language === 'ar' ? 'قيمة المخزون' : 'Stock Value'}</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow-sm border">
            <div className="flex items-center">
              ...
              <div className={`${language === 'ar' ? 'mr-4' : 'ml-4'}`}>
                <p className="text-2xl font-bold text-gray-900">{warehouseData.overview.lowStock}</p>
          ...
          <div className="bg-white p-6 rounded-lg shadow-sm border">
            <div className="flex items-center">
              ...
              <div className={`${language === 'ar' ? 'mr-4' : 'ml-4'}`}>
                <p className="text-2xl font-bold text-gray-900">{warehouseData.overview.outOfStock}</p>
                <p className="text-sm text-gray-600">{language === 'ar' ? 'نفد المخزون' : 'Out of Stock'}</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow-sm border">
            <div className="flex items-center">
              ...
              <div className={`${language === 'ar' ? 'mr-4' : 'ml-4'}`}>
                <p className="text-2xl font-bold text-gray-900">{warehouseData.overview.warehouses}</p>
                <p className="text-sm text-gray-600">{language === 'ar' ? 'المستودعات' : 'Warehouses'}</p>
              </div>
            </div>
          </div>
        </div>
                ...
                <div className="flex flex-col md:flex-row gap-4 flex-1">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    >
                      ...
                      <option value={language === 'ar' ? 'مواد البناء' : 'Construction'}>{language === 'ar' ? 'مواد البناء' : 'Construction'}</option>
                      <option value={language === 'ar' ? 'إلكترونيات' : 'Electronics'}>{language === 'ar' ? 'إلكترونيات' : 'Electronics'}</option>
                      <option value={language === 'ar' ? 'قطع غيار' : 'Auto Parts'}>{language === 'ar' ? 'قطع غيار' : 'Auto Parts'}</option>
                      <option value={language === 'ar' ? 'كيماويات' : 'Chemicals'}>{language === 'ar' ? 'كيماويات' : 'Chemicals'}</option>
                    </select>
                  </div>
                </div>
                        ...
                        <tr key={item.id} className="hover:bg-gray-50">
                          ...
                          <td className="px-6 py-4">
                            <div>
                              ...
                              <div className="text-sm text-gray-500">
                                {language === 'ar' ? 'حد أدنى:' : 'Min:'} {item.minStock} • {language === 'ar' ? 'حد أقصى:' : 'Max:'} {item.maxStock}
                              </div>
                            </div>
                          </td>
          ...
          <div>
            <div className="bg-white rounded-lg shadow-sm border">
              <div className="p-6 border-b">
                <h3 className="text-lg font-semibold text-gray-900">{language === 'ar' ? 'حركات المخزون' : 'Stock Movements'}</h3>
              </div>
              <div className="overflow-x-auto">
                <table className="w-full">
                  <thead className="bg-gray-50 border-b">
                      ...
                      <tr key={movement.id} className="hover:bg-gray-50">
                        ...
                        <td className="px-6 py-4">
                          <div className="text-sm text-gray-900">
                            <div>{language === 'ar' ? 'من:' : 'From:'} {movement.from}</div>
                            <div>{language === 'ar' ? 'إلى:' : 'To:'} {movement.to}</div>
                          </div>
                        </td>
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                          {movement.date}
        ...
        {activeTab === 'warehouses' && (
          <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-6">
            {warehouseData.warehouses.map((warehouse) => (
              <div key={warehouse.id} className="bg-white rounded-lg shadow-sm border hover:shadow-md transition-shadow">
                <div className="p-6">
                  ...
                  <div className="mb-4">
                    <div className="flex items-center justify-between mb-2">
                      <span className="text-sm text-gray-600">{language === 'ar' ? 'السعة المستخدمة' : 'Capacity Used'}</span>
                    ...
                    <p className="text-xs text-gray-500 mt-1">
                      {Math.round((warehouse.occupied / warehouse.capacity) * 100)}% {language === 'ar' ? 'مستخدم' : 'utilized'}
                    </p>
                  </div>

                  {/* Categories */}
                  <div className="mb-4">
                    <p className="text-sm text-gray-600 mb-2">{language === 'ar' ? 'الفئات المخزنة:' : 'Stored Categories:'}</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="bg-white p-6 rounded-lg shadow-sm border hover:shadow-md transition-shadow cursor-pointer">
              <div className="flex items-center mb-4">
                ...
                <div className="ml-4">
                  <h3 className="font-semibold text-gray-900">{language === 'ar' ? 'تقرير المخزون' : 'Inventory Report'}</h3>
                  <p className="text-sm text-gray-600">{language === 'ar' ? 'حالة المخزون الحالي' : 'Current inventory status'}</p>
                </div>
              </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm border hover:shadow-md transition-shadow cursor-pointer">
              <div className="flex items-center mb-4">
                ...
                <div className="ml-4">
                  <h3 className="font-semibold text-gray-900">{language === 'ar' ? 'تقرير الحركات' : 'Movement Report'}</h3>
                  <p className="text-sm text-gray-600">{language === 'ar' ? 'حركات الدخول والخروج' : 'In/out movements'}</p>
                </div>
              </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm border hover:shadow-md transition-shadow cursor-pointer">
              <div className="flex items-center mb-4">
                ...
                <div className="ml-4">
                  <h3 className="font-semibold text-gray-900">{language === 'ar' ? 'تقرير النواقص' : 'Stock Alert Report'}</h3>
                  <p className="text-sm text-gray-600">{language === 'ar' ? 'الأصناف المنخفضة والنافدة' : 'Low and out of stock items'}</p>
                </div>
              </div>
