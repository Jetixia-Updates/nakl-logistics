  ...
  const invoices = [
    {
      ...
      services: [
        {
          name:
            language === 'ar'
              ? 'نقل بري من القاهرة للإسكندرية'
              : 'Land transport Cairo to Alexandria',
          quantity: 1,
          rate: 100000,
          amount: 100000,
        },
        {
          name: language === 'ar' ? 'تأمين البضائع' : 'Cargo insurance',
          quantity: 1,
          rate: 15000,
          amount: 15000,
        },
        {
          name: language === 'ar' ? 'رسوم إضافية' : 'Additional fees',
          quantity: 1,
          rate: 10000,
          amount: 10000,
        },
      ...
      notes:
        language === 'ar'
          ? 'دفع خلال 30 يوم من تاريخ الفاتورة'
      ...
      services: [
        {
          name:
            language === 'ar'
              ? 'نقل بحري من الإسكندرية لدمياط'
              : 'Sea transport Alexandria to Damietta',
          quantity: 1,
          rate: 70000,
          amount: 70000,
        },
        {
          name: language === 'ar' ? 'تخليص جمركي' : 'Customs clearance',
          quantity: 1,
          rate: 15000,
          amount: 15000,
        },
    ...
    },
    {
      ...
      services: [
        {
          name:
            language === 'ar' ? 'نقل خاص للمعدات الثقيلة' : 'Special transport for heavy equipment',
          quantity: 2,
          rate: 100000,
          amount: 200000,
        },
        {
          name: language === 'ar' ? 'خدمات إضافية' : 'Additional services',
          quantity: 1,
          rate: 20000,
          amount: 20000,
        },
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">
            {language === 'ar'
              ? 'إدارة الفواتير ومتابعة المدفوعات'
              ...
              <div className="p-6">
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between mb-6">
                  <div className="flex items-start gap-4 mb-4 md:mb-0">
                    <div
                      className={`p-3 rounded-lg ${getStatusColor(invoice.status)} bg-opacity-20`}
                    >
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">
                        {language === 'ar' ? 'أمر العمل:' : 'Work Order:'} {invoice.workOrder}
                      </p>
                      <div className="flex items-center gap-2 mt-1">
                        <span
                          className={`inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full text-xs font-medium ${getStatusColor(invoice.status)}`}
                        >
                          {getStatusIcon(invoice.status)}
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center gap-2">
                      <Calendar className="w-4 h-4 text-gray-400" />
                      <span
                        className={`text-sm ${invoice.status === 'overdue' ? 'text-red-600 font-medium' : 'text-gray-900'}`}
                      >
                        {invoice.dueDate}
                      </span>
                    </div>
                        ...
                        >
                          <div className="flex-1">
                            ...
                            <p className="text-xs text-gray-600">
                              {language === 'ar' ? 'الكمية:' : 'Qty:'} {service.quantity} ×{' '}
