...
export default function AdminDashboard() {
  ...
  return (
    <div
      className={`min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-gray-50 ${language === 'ar' ? 'font-arabic' : 'font-inter'}`}
    >
      <div className="container mx-auto px-3 py-6 max-w-[2560px]">
        ...
        <div className="mb-6">
          ...
          <p className="text-sm text-gray-600">
            {language === 'ar'
              ? 'نظرة شاملة على أداء الأعمال والعمليات'
              : 'Comprehensive overview of business performance and operations'}
          </p>
        </div>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 xl:grid-cols-8 gap-3 mb-6">
          ...
          <div className="col-span-1 lg:col-span-2 bg-white rounded-lg shadow-sm border border-gray-200 p-4 hover:shadow-md transition-shadow">
            ...
            <p className="text-xs text-gray-500 mt-1">
              {((stats.revenue.total / stats.revenue.target) * 100).toFixed(0)}%{' '}
