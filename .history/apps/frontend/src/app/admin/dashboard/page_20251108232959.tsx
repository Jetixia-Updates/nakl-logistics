        ...
        <div className="flex items-center justify-between mb-8">
          ...
          <div className="flex items-center gap-3">
            <select
              ...
              aria-label={language === 'ar' ? 'اختر الفترة الزمنية' : 'Select time period'}
          ...
          <div className="group relative bg-white rounded-2xl p-6 border-2 border-orange-100 hover:border-orange-300 overflow-hidden hover:shadow-xl transition-all duration-300">
            ...
            <div className="relative z-10">
              ...
              <h3 className="text-3xl font-bold text-gray-900 mb-1">
                ...
                <span className="text-lg text-gray-400">/{stats.vehicles.total}</span>
              </h3>
              <p className="text-sm text-gray-600 font-medium mb-2">
        ...
        <div className="grid grid-cols-1 xl:grid-cols-3 gap-6 mb-6">
          ...
          <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-6 hover:shadow-2xl transition-all duration-300">
            <div className="flex items-center justify-between mb-6">
              ...
              <button 
                aria-label={language === 'ar' ? 'تصفية النتائج' : 'Filter results'}
                className="p-2 hover:bg-gray-100 rounded-lg transition-colors"
              >
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex items-center gap-3">
                      {/* Avatar */}
                      <div
                        className={`flex items-center justify-center w-12 h-12 rounded-xl font-bold text-sm ${
                          isFirst
          ...
          <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-6 hover:shadow-2xl transition-all duration-300">
            <div className="flex items-center justify-between mb-6">
              <div>
                ...
                <p className="text-sm text-gray-500 mt-1">
                  {language === 'ar' ? 'آخر ساعة' : 'Last hour'}
                </p>
              </div>
              ...
              <div className="space-y-4">
                {recentActivities.map((activity, index) => (
                  <div key={activity.id} className="relative flex items-start gap-4 group">
                    {/* Timeline Dot */}
                    <div
                      className={`relative z-10 p-2 rounded-xl ${getStatusColor(activity.status)} shadow-lg group-hover:scale-110 transition-transform`}
                    >
                ...
                >
                  <div className="flex items-start gap-3">
                    ...
                    <div className="relative flex items-center justify-center">
                      <input
                        type="checkbox"
                        aria-label={language === 'ar' ? `إتمام المهمة: ${task.task}` : `Complete task: ${task.task}`}
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-start justify-between gap-2 mb-2">
                        ...
                        {/* Priority Badge */}
                        <span
                          className={`flex items-center gap-1 text-xs px-2.5 py-1 rounded-full font-bold ${getPriorityColor(task.priority)}`}
                        >
