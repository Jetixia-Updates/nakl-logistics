...
export default function AdminDashboard() {
  ...
  return (
    <div className="min-h-screen bg-gray-100" dir="rtl">
      ...
      {/* Sidebar */}
      <div className={`fixed inset-y-0 right-0 w-64 bg-gray-900 transform ${sidebarOpen ? 'translate-x-0' : 'translate-x-full'} transition-transform duration-300 ease-in-out lg:translate-x-0 lg:static lg:inset-0 z-30`}>
        ...
        <nav className="mt-8 px-4">
          <div className="space-y-2">
            <SidebarLink href="/admin/dashboard" icon={<TrendingUp size={20} />} text="لوحة التحكم" active />
            <SidebarLink href="/admin/users" icon={<Users size={20} />} text="إدارة المستخدمين" />
            <SidebarLink href="/admin/shipments" icon={<Package size={20} />} text="إدارة الشحنات" />
            <SidebarLink href="/admin/vehicles" icon={<Truck size={20} />} text="إدارة المركبات" />
            <SidebarLink href="/admin/finance" icon={<DollarSign size={20} />} text="الإدارة المالية" />
            <SidebarLink href="/admin/reports" icon={<TrendingUp size={20} />} text="التقارير والإحصائيات" />
            <SidebarLink href="/admin/settings" icon={<Settings size={20} />} text="إعدادات النظام" />
          </div>
